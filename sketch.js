...
function preload(){
ground_image=loadImage("road.jpg");
  girl_running=loadAnimation("girl1.png","girl2.png","girl3.png","girl4.png","girl5.png","girl6.png","girl7.png","girl8.png");
  obstacle1=loadImage("fire.png");
  zombie_idle=loadImage("snk.jpg");
...
ground.scale=1;
   ...
   girl=createSprite(300,200,600,10);
 ...
 // girl.velocityX=2;
  ...
  zombie=createSprite(50,200,600,10);
